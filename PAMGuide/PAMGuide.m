...
switch fbv
    ...
    case 2
        ...
        ofile = ['PAMGuide_Batch_' atype '_' calstring '_' num2str(N) 'pt' winname 'Window' '_' num2str(r*100) 'pcOlap.mat'];         PG_Viewer(conk,plottype,ofile,linlog)
        ...
        fprintf('Writing concatenated output array...'),tic
            % disp('no conk write dub')
        if tstick == 1
            save(fullfile(path,ofile), 'conk', '-v7.3');
